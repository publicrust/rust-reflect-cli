...
namespace DotNetReflectCLI.Commands
{
    public class HelpCommand : Command
    {
        ...
        private void ShowGeneralHelp()
        {
            ...
            help.AppendLine("DotNetReflectCLI - Утилита для анализа и работы с декомпилированным .NET кодом\n");
            help.AppendLine("Использование:");
            help.AppendLine("  dotnet reflect <команда> [опции]\n");
            ...
            help.AppendLine("  dotnet reflect help --command <название_команды>\n");
            help.AppendLine("Примеры:");
            help.AppendLine("  dotnet reflect search --input Assembly.dll --string \"SearchText\"");
            help.AppendLine("  dotnet reflect decompile --input Assembly.dll --output ./output");
            help.AppendLine("  dotnet reflect analyze --input Assembly.dll --type \"MyNamespace.MyClass\"");
        ...
        private void ShowCommandHelp(string command)
        {
            ...
            switch (command.ToLower())
            {
                case "search":
                    ...
                    help.AppendLine("Использование:");
                    help.AppendLine("  dotnet reflect search [опции]\n");
                    ...
                    help.AppendLine("Примеры:");
                    help.AppendLine("  dotnet reflect search --input Assembly.dll --string \"MyMethod\"");
                    help.AppendLine("  dotnet reflect search --input ./Managed --string \"OnPlayerConnected\"");
                    help.AppendLine("  dotnet reflect search --input Assembly.dll --string \"MyClass\" --namespace \"MyNamespace\"");
                    break;

                // case "decompile":
                //     help.AppendLine("Декомпиляция всей сборки\n");
                //     help.AppendLine("Использование:");
                //     help.AppendLine("  dotnet reflect decompile [опции]\n");
                //     help.AppendLine("Опции:");
                ...
                case "decompile-type":
                    ...
                    help.AppendLine("Использование:");
                    help.AppendLine("  dotnet reflect decompile-type [опции]\n");
                    help.AppendLine("Опции:");
                    help.AppendLine("  --input <путь>  Путь к файлу сборки (обязательно)");
                    help.AppendLine("  --type <тип>    Полное имя типа для декомпиляции (обязательно)\n");
                    help.AppendLine("Примеры:");
                    help.AppendLine("  dotnet reflect decompile-type --input Assembly.dll --type \"MyNamespace.MyClass\"");
                    break;

                case "analyze":
                    help.AppendLine("Анализ использования типов\n");
                    help.AppendLine("Использование:");
                    help.AppendLine("  dotnet reflect analyze [опции]\n");
                    help.AppendLine("Опции:");
                    help.AppendLine("  --input <путь>  Путь к файлу сборки (обязательно)");
                ...
                default:
                    ...
                    help.AppendLine("Используйте 'dotnet reflect help' для просмотра списка доступных команд.");
                    break;
            }
